...
\entry{1948}{F. Hoyle propose un modèle stationnaire de l'Univers, dans lequel une création continue de matière compense la diminution de densité due à l'expansion, en contradiction avec le modèle de Lemaître que Hoyle surnomme théorie du "Big Bang"}
